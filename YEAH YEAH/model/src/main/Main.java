...
public class Main {
    ...
    public static  void mainMenu() {
        ...
        System.out.println("***********************************************************************");
        System.out.println("**                                                                   **");
        System.out.println("** WELCOME TO HALİT'S CAR/CUSTOMER MANAGEMENT AND CAR RENTAL SYSTEM  **");
        System.out.println("**                                                                   **");
        System.out.println("***********************************************************************");
        System.out.println("***********************************************************************");
    ...
    public static void main(String[] args) {
        ...
        LambdaFunctionInterface PromptPrinterMethod = () -> System.out.println("Please enter password");

        // lambda function implementation
        LambdaFunctionInterface PromptPrinterCredentialErrorMethod = () -> System.out.println("Wrong credentials!");
        Scanner in = new Scanner(System.in);
        ...
        PromptPrinterMethod.apply();
        String password = in.nextLine();


        // generic method implementation
        if(isEqual(username, "test") && isEqual(password, "pass") ){
            mainMenu();
        }else{
            PromptPrinterCredentialErrorMethod.apply();
        }
